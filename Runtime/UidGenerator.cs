...
namespace Aarthificial.Typewriter
{
    ...
    {
        private const string _machineIdPrefKey = "Aarthificial.Typewriter.Common.UidGenerator.MachineId";
        private const string _sequencePrefKey = "Aarthificial.Typewriter.Common.UidGenerator.Sequence";

        private const int _machineIdBits = 10;
        private const int _sequenceBits = 12;

        private static readonly int _maxMachineId = (int)(Mathf.Pow(2, _machineIdBits) - 1);
        private static readonly int _maxSequence = (int)(Mathf.Pow(2, _sequenceBits) - 1);
        ...
        private static int MachineId
        {
            get
            {
                if (_machineId == 0) _machineId = GetMachineId();
                return _machineId;
            }
            set
            {
