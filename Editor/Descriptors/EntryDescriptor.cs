...
namespace Aarthificial.Typewriter.Editor.Descriptors
{
    ...
    public class EntryDescriptor
    {
        ...
        public virtual void CreateNextMenu(BaseEntry entry, List<string> names, List<int> ids, ref int current) { }
        ...
        /// </param>
        /// <param name="current">The index of the currently select option.</param>
        public virtual void CreateAlternativeMenu(BaseEntry entry, List<string> names, List<int> ids, ref int current) { }
        ...
        /// </param>
        /// <param name="current">The index of the currently select option.</param>
        public virtual void CreatePreviousMenu(BaseEntry entry, List<string> names, List<int> ids, ref int current) { }
        ...
        public virtual void HandleEntryCreated(BaseEntry entry, DatabaseTable table) { }
    }
}
