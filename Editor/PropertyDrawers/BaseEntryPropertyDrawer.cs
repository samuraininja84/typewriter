    ...
    public class BaseEntryPropertyDrawer : PropertyDrawer
    {
        ...
        private IEnumerable<SerializedProperty> GetChildren(SerializedProperty property)
        {
            ...
            do
            {
                ...
                if (omittedFields.Contains(iterator.name)) continue;
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            var visualTree = Resources.Load<VisualTreeAsset>("UXML/Layout/InspectorView");
        ...
        protected virtual void PopulateContent(VisualElement root, SerializedProperty property)
        {
