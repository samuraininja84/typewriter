...
namespace Aarthificial.Typewriter.Editor.PropertyDrawers
{
    ...
    public class DispatcherPropertyDrawer : PropertyDrawer
    {
        ...
        {
            var referenceProperty = property.FindPropertyRelative(nameof(RuleEntry.Dispatcher.Reference));
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.PropertyField(position, referenceProperty, GUIContent.none, true);
