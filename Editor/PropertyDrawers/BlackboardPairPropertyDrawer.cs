...
namespace Aarthificial.Typewriter.Editor.PropertyDrawers
{
    ...
    public class BlackboardPairPropertyDrawer : PropertyDrawer
    {
        ...
        {
            var referenceProperty = property.FindPropertyRelative(nameof(Blackboard.Pair.Key));
            var valueProperty = property.FindPropertyRelative(nameof(Blackboard.Pair.Value));
