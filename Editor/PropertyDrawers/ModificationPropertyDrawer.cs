...
namespace Aarthificial.Typewriter.Editor.PropertyDrawers
{
    ...
    public class ModificationPropertyDrawer : PropertyDrawer
    {
        ...
        {
            var referenceProperty = property.FindPropertyRelative(nameof(BlackboardModification.FactReference));
            var typeProperty = property.FindPropertyRelative(nameof(BlackboardModification.Operation));
            var valueProperty = property.FindPropertyRelative(nameof(BlackboardModification.Value));
            ...
            if (typeProperty.enumValueIndex == (int)BlackboardModification.OperationType.SetReference)
            {
                valueProperty.intValue = EntryReferencePropertyDrawer.CollectionEntryPicker
                (
                    position,
