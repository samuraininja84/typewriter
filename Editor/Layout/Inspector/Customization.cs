...
namespace Aarthificial.Typewriter.Editor.Layout.Inspector
{
    public class Customization : VisualElement
    {
        ...
        {
            var visualTree = Resources.Load<VisualTreeAsset>("UXML/Layout/Inspector/Customization");
        ...
        private PropertyListItem CreateListItem() => new PropertyListItem();
        ...
        public void BindProperty(SerializedProperty property)
        {
            ...
            foreach (var list in _lists)
            {
                ...
                if (listProperty != null) _container.Add(list.Value);
            }
        }
