...
namespace Aarthificial.Typewriter.Editor.Localization
{
    public class LocalizedTextEditor : TextField
    {
        ...
        public LocalizedTextEditor(SerializedProperty property) : this() => BindProperty(property);
        ...
        private void UndoRedoPerformed() => SetValueWithoutNotify(_binding.Value);

        private void HandleFieldChanged(ChangeEvent<string> evt) => _binding.Value = evt.newValue;

        private void HandleEntryChanged() => SetValueWithoutNotify(_binding.Value);
