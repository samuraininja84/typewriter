...
namespace Aarthificial.Typewriter.Editor.Localization
{
    ...
    {
        protected override void PopulateContent(VisualElement root, SerializedProperty property)
        {
            root.Add(new LocalizedTextEditor(property.FindPropertyRelative(nameof(LocalizedRuleEntry.Text)))
            {
                multiline = true,
                style =
                {
